...
<template>
  <div>
    <div class="mt-6 grid md:grid-cols-2 gap-3">
      <div class="primary-border bg-[#080808]/95 p-4 lg:p-5 rounded-[10px]">
        <p class="text-secondary font-dm tracking-[-0.75px]">
          Withdrawal Funds
        </p>

        <form class="mt-5 space-y-4">
          <div>
            <label for="" class="text-[10px] text-white font-medium mb-2"
              >Amount</label
            >
            <input
      ...
      <div class="primary-border bg-[#080808]/95 p-4 lg:p-5 rounded-[10px]">
        <div class="flex justify-between items-center">
          <p class="text-secondary font-dm tracking-[-0.75px]">Activity</p>
        ...
        <div>
          ...
          >
            <div class="flex items-center gap-2">
              <button class="p-3 primary-border bg-[#0F0B08] rounded-full">
                <Wallet1 />
              </button>
