...
const series = [
  {
    name: "Income",
    data: [18, 36, 58, 18, 45, 67, 89, 23, 56, 78],
  },
];
...
<template>
  <section class="relative overflow-hidden primary-border rounded-xl bg-[#050505]">
    ...
    <div class="relative z-0 h-45 sm:h-60 lg:h-82.5">
      <ClientOnly>
        <ApexChart
          type="bar"
          height="100%"
