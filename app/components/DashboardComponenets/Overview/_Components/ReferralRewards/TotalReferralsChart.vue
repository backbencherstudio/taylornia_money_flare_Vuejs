...
const series = [
  {
    name: "Referrals",
    data: [0, 22, 46, 24, 58, 74, 48, 25, 53, 61, 49, 70, 45, 26, 39, 63, 88, 97, 93, 102],
  },
];
...
<template>
  ...
  >
    ...
    <div class="relative z-10 p-5">
      <p class="text-secondary">Total Referrals</p>
      <h3 class="mt-2 text-2xl font-semibold text-white">84</h3>
