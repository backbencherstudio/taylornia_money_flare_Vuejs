...
<template>
  <nav
    class="bg-[#03030333] backdrop-blur-[5px] border-b border-white/10 fixed w-full z-50"
  >
    <div class="max-w-7xl mx-auto px-6 xl:px-10">
      <div class="flex items-center justify-between py-2 xl:py-5">
        <div class="flex items-center gap-10">
          <NuxtLink
            to="/"
            class="text-white text-2xl lg:text-[2.5rem] font-semibold"
          >
        ...
        <div class="hidden lg:flex items-center gap-10">
          <div class="flex items-center gap-6">
            ...
            <BaseButtonLink to="/auth/signup"> Get Started </BaseButtonLink>
          </div>
        </div>
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          ...
          <BaseButtonLink to="/auth/signup" @click="isMenuOpen = false">
            Get Started
          </BaseButtonLink>
        </aside>
      </div>
