    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24">
        <g class="x-circle-outline">
            <g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd">
                ...
                <path d="M8.293 8.293a1 1 0 0 1 1.414 0l6 6a1 1 0 1 1-1.414 1.414l-6-6a1 1 0 0 1 0-1.414" />
                <path d="M15.707 8.293a1 1 0 0 1 0 1.414l-6 6a1 1 0 0 1-1.414-1.414l6-6a1 1 0 0 1 1.414 0" />
            </g>
        </g>
    </svg>
</template>
